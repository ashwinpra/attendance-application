...
members.\\
The project will involve three levels of testing - Unit, System/Integration, and Acceptance - each with its own specific goals and requirements.\\
...
\begin{itemize}
    ...
    \item ACCEPTANCE Testing will be performed by the actual end users with the assistance of the test manager and developers. The acceptance test will be done in parallel with the existing manual ZIP/FAX process for a period of one month after completion of the System/Integration test process.
